...
I've been using Cursor for about a year. I’d used SourceGraph plus a defunct startup plugin in a VSCode for 15 months before that. Using LLMs across these apps were already useful but one misstep could lead to three hours down a rabbit-hole where hard-won solutions led to the same 2nd order effect that instigated the chase.
...
**Use [this cursor rule](https://github.com/callumflack/callums-prompts/blob/main/cursor-global-cursorteam-250102.md).** Your mileage may vary but because I'm just building web apps this works. “Be terse” is most important because, most of all, you have to manage the context window in your own head.
