...
Probably the most underrated part here is the "Owner and oracle" directive, which gives me an eval everytime an agent runs: it prints how it understands my ask before any further work is done.
