...
draft: false
summary: English is the new programming language. But fluency isn't proof. A vocabulary for keeping LLM collaboration answerable instead of merely fluent—tied to the repo, test, or source that can say no.
category: writing
assets:
  - src: /images/post-answerable-vocabulary-1920-1080.jpg
    aspect: 1920-1080
    alt: An answerable vocabulary for LLM collaboration
tags:
  - agents
  - language
  - thinking
tweet: https://x.com/callumflack/status/2072206618553618767
---
...
Not: is this fluent? Nor: does this phrase sound right? Nor: does this look like good work? Those are local signals. They can all pass while the work never touches the thing that owns the truth.

Instead: what makes this answerable?
