...
The GAI we have now does not automate the work of people. Instead they work best as augmentations and accelerants for a person who already has deep expertise in some domain. They're flawed, but en-mass they provide momentum, allowing people to "get past the hard part" with regards writer's block, code [rubber-ducking](https://en.wikipedia.org/wiki/Rubber_duck_debugging) and so on.
...
I recommend watching [Solaris](https://www.criterion.com/current/posts/239-solaris-inner-space) as your entry point to thinking about cloning intelligence and its implications (far more so than Her, which is really [a sequel](https://x.com/callumflack/status/1627814766579429376) to Lost In Translation by the ex-husband of that film's director). If you can be doubled, what is you?
...
My guess is that it will be natural for people to project on to GAI the status of oracle because they will unconsciously conflate language with sentience and thus the projection of sentience onto GAI. This will be a deeply-rooted mistake, as obscure as the way in which we forget we unconsciously breathe.
...
GAI doesn’t hallucinate. It has a theory of language, from which it may deduce a theory of mind (non-biologically; without a body) but it isn't sentient. It's we, the sentient, who hallucinate, and fantastically so. What we think GAI is says more about us than it does about GAI. They reflect us.

Any supposed oracle is a not-oracle, unless you're willing to look sideways at said talisman as an embodied entity of the "imagi­nal realm, visible and vibrating states of what remains [generally invisible"](https://engelsbergideas.com/essays/after-hilma-af-klint-the-influence-of-theosophy-on-contemporary-art). The connection need only be conceptual, speculative even, to be useful. From simple attendance to some form of one's own thought, through to [systematic divination processes](https://en.wikipedia.org/wiki/I_Ching)—you may take any sign you wish, and it can tell you something about your next intention, if you wish. Nobody else can answer the questions you have of yourself except for yourself. But you may prompt yourself.
...
Signs, images, word and dreams. Oracles exist when we don't see them as oracles. They exist in the processes of contemplation we're so used to that we hardly pay attention to. And even when we can access them, they don't tell us the answers. Instead they prompt us to attend to ourselves.
...
All of this means that to make use of GAI, [taste](/the-matter-of-taste) is even more important.
...
The ability to suggest from and play with imagination will enhance and unfold GAI interactions.
...
The most generative way of seeing LLMs is not as a matrix or a copy or even as a seed but as a materialisation of your conceptions, the ones you choose to project onto the mirror image you see. What you think-imagine-perceive-project is what you see-hallucinate-distort.
