...
If GAI eats language, how then do I think about it? What is their intention to know? Is it us versus them? Is it an animal that reads minds? Do I think soley in words? If I do not, then I can hide myself from their consumption. So what then are the "embodied entities of the imaginal realm, the visible, [vibrating states"](https://engelsbergideas.com/essays/after-hilma-af-klint-the-influence-of-theosophy-on-contemporary-art) of me that will remain generally invisible to the GAI that eats language?
...
- Not-Oracles
- Companions (social and augmentation)
...
The GAI we have now does not automate the work of people. Instead they work best as augmentations for a person who already has deep expertise in some domain. They're flawed, but en-mass they provide momentum, allowing people to "get past the hard part" with regards writer's block, code [rubber-ducking](https://en.wikipedia.org/wiki/Rubber_duck_debugging) and so on.

This means that if you have [taste](/the-matter-of-taste) within a domain, you can start to think about how you might augment what you do. If everyone can use LLMs to speed up some workflow, the difference in the way you perform that workflow is going to be a matter of your taste.

This framing extends upon the notion of correctness, and indicates it's usefulness as a knowledge-work sidekick, which I write more about below.
...
GAI is in many ways a replication of our thoughts and words. The notion of cloning (genetically identical copies of people) and mirrors (evil twins and doppelgängers) bring into focus deep-seated assumptions of human identity and the perception of the Other.

I recommend watching [Solaris](https://www.criterion.com/current/posts/239-solaris-inner-space) as your entry point to thinking about artifical cloning and its implications (far more so than Her, which is really [a sequel](https://x.com/callumflack/status/1627814766579429376) to Lost In Translation). If you can be doubled, what is you?
...
The mirror image becomes the revelation that our normal state was always incomplete. The substance is that advanced technology is autopoietic
...
Consider too the mutated idea of [Tulpas](https://www.wikihow.com/Create-a-Tulpa) from Twin Peaks 3, which sure sounds programmatic:
...
GAI is functionally tulpaic — it's sustained human intentionality ("training") creating quasi-autonomous cognitive entities from "seeds" (data) and "organic material" (human linguistic patterns). Applied contemplative technology, fantastically so, if I so wish.

Mirrors, doppelgangers, clones. Symmetries of metaphor. Perhaps we can say that GAI might become the left hand to our right, some better angels of our nature? Might GAI be chiral in it's non-superposable reflection of us? Can we use word puns to arrive at an understanding of GAI as human handedness but ultimately constrained as an irreducibly dual system?
...
We assume something that speak to us is sapient because since time immemorial only humans speak. We implicitly assume language is sapience. But though they are perfectly capable of natural language processing, LLMs are not sapient.

Mention of oracles indicates a projection of imagination. Which is literally fantastic—phantasia means to appear from imagination. We want to be fantastic with our projections of handedness! What matters is the awareness around such thinking, especially if we ourselves do not understand how LLM "black boxes" really work.

If GAI was an oracle, it would be super-intelligent. It isn't right now. It's more like a really smart idiot that does exactly what you tell it—able to expound specific knowledge at great speed but unable to accrete any agency for itself. Thus, one must take care to placate one's own biases before asking (what is called currently called "prompting").
...
Ah! Now let me contradict myself: "more about ourselves than AI" is an emerging theme here. We could say doppelgangers, mirrors, eighteenth-century typography, the taste of coffee, and Stansilaw Lem's prose, are all indeed oracles when you look at them in the right way… But it takes us to look at them.
...
My guess is that it will be natural for people almost immediately to project GAI as an oracle. And that will be deeply-rooted mistake, as obscured as the way in which we forget we are unconsciously breathing every minute.

> Mirror, mirror on the wall, who's the fairest of them all?

GAI doesn’t hallucinate. It has a theory of language, from which it may deduce a theory of mind (non-bioloigcally; without a body) but it isn't sentient. It's we who hallucinate, fantastically so. What we think of GA is says more about us than it does about GAI. They reflect us.
...
- Augmentation companion. For knowledge-work such as code, writing, etc. Also called assistant, daemon. Or maybe demon (the non-oracle).
...
A sidekick—aka copilot, assistant, daemon-muse, Sancho Panza or your own personal Jesus—for any form of knowledge work will give people who are good at what they do a 10x lever. If you have the knowhow and the right questions, you can increase your cycle speed by an order of magnitude.
...
It's not an animal. Nor an oracle. It's a tool. If you wish to look at it that way.

You'll notice I framed this with the Archimedes meme, the original "10x lever" guy. But should we really be "measuring" at this stage? Is that really how we should approach this magic chrial handedness? Maybe for those that make the models, but I'm not that smart. We all know what happens to those that measure targets. My evals are metaphors.
...
All of this means that to make use of Generative AI, [taste](/the-matter-of-taste) is even more important.
...
The ability to suggest from imagination will be crucial to any interaction.
...
The most generative way of seeing LLMs is not as a matrix or a copy or even as a seed but as a materialisation of your conceptions, the ones you choose to project in the mirror. Your mileage will vary.

What you &lt;think/imagine/perceive/project&gt; is what you &lt;see/hallucinate/distort&gt;.

AI is a mirror. And a mirror is a vertical body of water. Jump in.
