...
summary: A chair’s form emerges from its material and joinery. An interface’s form emerges from its code. You cannot design either surface independently of the structure that makes it work.
assets:
