...
summary: Because Generative AI is a new general purpose platform, it is difficult to reason about its current use case potential, and what shape its native products will take. To help me think about it, I'm listing some favourite frames, metaphors, dimensions and questions from the past year of reading.
assets:
