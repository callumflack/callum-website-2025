...
After serendipitously meeting [Rob Austin](https://x.com/ausrobdev), the founder of [Shadcnblocks](https://www.shadcnblocks.com/) (among other ventures), we agreed that I'd design a theme for Shadcnblocks. It was so much fun we ended up doing three.
...
Each theme used a pseudo software start-up product as it's audience. For each theme, I started by choosing a typeface (which had to be free given theme sharing constraints) and then play around with current website design trends. Once I'd completed both desktop and mobile versions, Rob coded them.
