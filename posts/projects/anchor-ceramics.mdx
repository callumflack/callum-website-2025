...
assets:
  - src: https://cfd-media.b-cdn.net/anchor-ceramics-02.mp4
    ...
    aspect: 1728-1080 # This will be parsed to 1.6 by ContentCollections
category: projects
tags:
  - engineering
  - featured
...
My favourite part of this project was taking the time to properly render 12-step background gradients on the sticky navigation to transparent fade over the content without browser artefacting.
