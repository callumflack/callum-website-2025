  ...
  return (
    ...
    >
      {projects.map((project, index) => {
        ...
        // Get default dimensions and process based on asset type
        ...
        return (
          <Link
            ...
            className={cx(
              ...
              classes
              // isPortrait
              //   ? "isPortrait max-w-[280px] lg:max-w-[280px]"
              //   : isSquare
              //     ? "max-w-[320px] lg:max-w-[450px]"
              //     : "max-w-[400px] lg:max-w-(--container-text)"
            )}
          >
            <MediaFigure
