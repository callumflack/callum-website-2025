...
import { Intro, Outro } from "@/components/page/block-intro";
import { Nav } from "./nav";
...
/*
 * ARCHIVE FIXUP: removed the `getCategoryNavRoute` helper. It was only used by
 * post pages, never by this homepage, and it switched on Category.NOTE /
 * Category.ABOUT — enum members that no longer exist. The live version in
 * @/components/page/page-wrapper is the maintained one.
 */
...
export const PageWrapper = ({
  ...
  return (
    <>
      {/* ARCHIVE FIXUP: dropped `componentName="PageWrapper-Nav"` — Nav never
          declared or used the prop; it was silently ignored. */}
      <Nav
        activeNav={activeNav}
        anchorName="Callum"
        navItems={[
