...
import { GRID_TOGGLE_ENABLED, HomePage } from "./home-page";
import { HomeLayoutShell } from "./home-layout-shell";

/*
 * ARCHIVE — homepage as of 2026-04, lifted from src/app/page.tsx at 759637e
 * ("Home page redesign #8" era, live Apr 2026 → Jul 2026). Reachable at
 * /home-2604 for reference; noindex, and absent from sitemap.ts.
 * Its (home)/* dependencies are frozen alongside it in this directory, so the
 * live ones stay free to change.
 */

export const metadata: Metadata = {
  title: "Home archive — 2026-04",
...
export default function HomeArchive2604() {
